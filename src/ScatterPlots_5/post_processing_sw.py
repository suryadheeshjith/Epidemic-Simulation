...
plot(X,Y,clean(Z, 9, 10),"Optimal pooling strategy given Beta and Gamma","Rate of Infection(Beta)","Rate of Recovery(Gamma) ")

# fn, fp
X,Y,Z = print_optimal_rows('fn_fp.csv','fn','fp')
plot(X,Y,clean(Z, 9, 10),"Optimal pooling strategy given False Negative and False Positive rates","False Negative rate","False Positive rate")
#
# # # n, p
X,Y,Z = print_optimal_rows('np.csv','n','p')
plot(X,Y,clean(Z, 5, 6),"Optimal pooling strategy given n and p","Number of agents (n)","Probability of edge (p)")
#
#
# # Gap tests, tests_per_period
X,Y,Z = print_optimal_rows('gap_tests.csv','testing_gap','tests_per_period')
plot(X,Y,clean(Z, 5, 10),"Optimal pooling strategy given number of tests and period for testing","Gap between testing periods","Tests per testing period")
...
plot(X,Y,clean(Z, 5, 10),"Optimal pooling strategy given Turnaround and Restriction time","Test result turnaround time","Positive agent restriction time")
