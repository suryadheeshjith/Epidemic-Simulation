...
# Beta, gamma
X,Y,Z = print_optimal_rows('beta_gamma_90.csv','beta','gamma')
...
X,Y,Z = print_optimal_rows('gap_tests_inav.csv','testing_gap','tests_per_period')
...
X,Y,Z = print_optimal_rows('turnaround_restriction_90.csv','turnaround_time','restriction_time')
