...
def probabilityOfInfection_fn(p_infected_states_list,contact_agent,c_dict,current_time_step):
	if contact_agent.state=='Infected':
		return 0.03  #This is the probability of getting infected from contact in a time step isf contact is infected
...
class UserModel(Model.StochasticModel):
	def __init__(self):
		...
		self.set_transition('Infected', 'Recovered', self.p_standard(0.12))	#Adding the I->R transition
