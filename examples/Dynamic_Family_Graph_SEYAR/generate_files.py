...
def write_interactions(filename,n,p,family_sizes,connected=True):
		...
		# for i in range(n):
		# 	dsum+=len(adj_list[i])
		# average_degree=2*dsum/n

p=float(sys.argv[1])
fam_size = [0.0,0.0,0.0,1.0]
# write_interactions('interactions_list1.txt',1000,p,fam_size)
# write_interactions('interactions_list2.txt',1000,p,fam_size)
# write_interactions('interactions_list3.txt',1000,p,fam_size)
# write_interactions('interactions_list4.txt',1000,p,fam_size)
# write_interactions('interactions_list5.txt',1000,p,fam_size)
# write_interactions('interactions_list6.txt',1000,p,fam_size)
# write_interactions('interactions_list7.txt',1000,p,fam_size)
# write_interactions('interactions_list8.txt',1000,p,fam_size)
# write_interactions('interactions_list9.txt',1000,p,fam_size)
# write_interactions('interactions_list10.txt',1000,p,fam_size)
str_begin = "interactions_list"
str_end = ".txt"

for i in range(11,51):
	file_name = str_begin+str(i)+str_end
	write_interactions(file_name,1000,p,fam_size)
